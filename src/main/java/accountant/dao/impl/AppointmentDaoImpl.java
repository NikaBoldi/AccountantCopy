...
public class AppointmentDaoImpl extends AbstractDao<Integer, AppointmentDb> implements AppointmentDao {

    @Override
    public Set<AppointmentDb> getByDate(Date from, Date to) {
        return null;
    }

    @Override
    public Set<AppointmentDb> getByPatient(UserDb patient) {
        return null;
    }

    @Override
    public AppointmentDb findById(int id) {
        return null;
    }
}
/*
