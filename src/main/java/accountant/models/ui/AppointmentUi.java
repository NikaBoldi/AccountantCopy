...
public class AppointmentUi {
    ...
    private UserUi patient;
    private UserUi doctor;
    ...
    public UserUi getPatient() {
        return patient;
    }

    public void setPatient(UserUi patient) {
        this.patient = patient;
    }

    public UserUi getDoctor() {
        return doctor;
    }

    public void setDoctor(UserUi doctor) {
        this.doctor = doctor;
    }
